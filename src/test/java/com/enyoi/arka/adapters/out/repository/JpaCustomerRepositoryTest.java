...
@DisplayName("JpaCustomerRepository - Test de Integracion")
public class JpaCustomerRepositoryTest {
    ...
    class SaveTests {
        ...
        void debeGuardarCategoriaNueva() {
            // Given
    ...
    class FindByIdTests {
        ...
        void debeEncontrarCategoriaPorIdExistente() {
            // Given
    ...
    class FindAllTests {
        ...
        @Test
        @DisplayName("Debe retornar lista vacía cuando no hay customer")
        void debeRetornarListaVaciaCuandoNoHayCustomer() {
            // When
        ...
        @Test
        @DisplayName("Debe retornar todos los customer")
        void debeRetornarTodosLosCustomer() {
            // Given
            ...
            repository.save(crearCustomer("cus-006", "manula", "manula@test.com", "quilla"));
    ...
    class FindByEmailTests {
        ...
        @Test
        @DisplayName("Debe encontrar customer por email")
        void debeEncontrarProductosPorEmail() {
            // Given
            repository.save(crearCustomer("cus-004", "manu", "manu@test.com", "quilla"));
            repository.save(crearCustomer("cus-005", "manuel", "manuel@test.com", "quilla"));
            repository.save(crearCustomer("cus-006", "manula", "manula@test.com", "quilla"));
        ...
        @Test
        @DisplayName("Debe retornar lista vacía si no hay customer en email")
        void debeRetornarListaVaciaSiNoHayCustomerEnEmail() {
            // Given
            repository.save(crearCustomer("cus-006", "manula", "manula@test.com", "quilla"));

            // When
            Optional<Customer> resultado = repository.findByEmail("no-existe@test.com");
...
class ExistsByIdTests {
    ...
    void debeRetornarTrueSiCustomerExiste() {
        // Given
        repository.save(crearCustomer("cus-004", "manu", "manu@test.com", "quilla"));
    ...
    void debeRetornarFalseSiCustomerNoExiste() {
        // When
...
class DeleteByIdTests {
    ...
    void debeEliminarCustomerExistente() {
        // Given
        repository.save(crearCustomer("cus-004", "manu", "manu@test.com", "quilla"));
    ...
    void noDebeLanzarExcepcionAlEliminarCustomerInexistente() {
